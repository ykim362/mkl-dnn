...
status_t rnn_desc_init(rnn_desc_t *rnn_desc,
        ...
        rnn_input_mode_t input_mode, size_t num_states, 
        size_t num_layers, size_t num_seqs,
        const memory_desc_t *x_desc,
        const memory_desc_t *hx_desc,
        const memory_desc_t *y_desc,
...
status_t mkldnn_rnn_forward_desc_init(rnn_desc_t *rnn_desc,
    ...
    return rnn_desc_init(rnn_desc, prop_kind, alg_kind, direction,
            input_mode, num_states, num_layers, num_seqs,
